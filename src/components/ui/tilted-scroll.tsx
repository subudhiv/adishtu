  ...
  return (
    <div className={cn("flex items-center justify-center", className)}>
      <div className="relative overflow-hidden [mask-composite:intersect] [mask-image:linear-gradient(to_right,transparent,black_5rem),linear-gradient(to_left,transparent,black_5rem),linear-gradient(to_bottom,transparent,black_5rem),linear-gradient(to_top,transparent,black_5rem)]">
        <div className="grid h-[250px] w-[300px] gap-5 animate-[skew-scroll_20s_linear_infinite] grid-cols-1">
          {items.map((item) => (
            <div
              key={item.id}
...
const defaultItems: TiltedScrollItem[] = [
  { id: "1", text: "No Added Preservatives" },
  { id: "2", text: "No Added Sugar" },
  { id: "3", text: "No Artificial Sweeteners" },
  { id: "4", text: "No Artificial Colors" },
  { id: "5", text: "No Artificial Flavors" },
  { id: "6", text: "No Dairy, Soy, Gluten" },
  { id: "7", text: "100% Natural Ingredients" },
  { id: "8", text: "Rich in Protein & Fiber" },
  { id: "9", text: "Antioxidant Rich" },
  { id: "10", text: "Energy Boosting" },
]
